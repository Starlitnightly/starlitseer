...
bool apihook::InitializeHook(hook_t* Hook, char* ModuleName, char* FunctionName, void* HookFunction)
    {
        HMODULE hModule;
...
bool apihook::InitializeByAddress(hook_t* Hook, void* Address, void* HookFunction)
    {
...
bool apihook::InsertHook(hook_t* Hook)
    {
        DWORD op;
        if (!Hook->isHooked) {
            return false;
...
bool apihook::Unhook(hook_t* Hook)
    {
        DWORD op;
        if (!Hook->isHooked) {
            return false;
...
bool apihook::FreeHook(hook_t* Hook)
    {
        if (Hook->isHooked) {
            return false;
        }
